...
export const users = [
  { id: '1', name: 'Mohammed Sufyan Ali', collegeId: 'cbit', rating: 4.8, earnings: 1250.00, avatarId: 'avatar-car-1' },
  { id: '2', name: 'Shahed Ali', collegeId: 'cbit', rating: 4.5, earnings: 800.00, avatarId: 'avatar-car-2' },
  { id: '3', name: 'Ayesha Firdous', collegeId: 'osmania', rating: 4.9, earnings: 2100.00, avatarId: 'avatar-flower-1' },
